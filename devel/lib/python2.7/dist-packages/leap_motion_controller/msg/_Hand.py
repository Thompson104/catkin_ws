...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_B3I.pack(_x.is_present, _x.palm_pose.header.seq, _x.palm_pose.header.stamp.secs, _x.palm_pose.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d2fB.pack(_x.palm_velocity.vector.x, _x.palm_velocity.vector.y, _x.palm_velocity.vector.z, _x.sphere_radius, _x.pinch_strength, _x.key_tap))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.is_present, _x.palm_pose.header.seq, _x.palm_pose.header.stamp.secs, _x.palm_pose.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      ...
      if python3:
        self.palm_velocity.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.palm_velocity.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 33
      (_x.palm_velocity.vector.x, _x.palm_velocity.vector.y, _x.palm_velocity.vector.z, _x.sphere_radius, _x.pinch_strength, _x.key_tap,) = _struct_3d2fB.unpack(str[start:end])
